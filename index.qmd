...
chat.chat(
  chatlas.content_image_file("./presentation/images/View_of_Monterrey.jpg"),
...
The volcano's distinctive sharp peaks are clearly visible.
```
...
chat.chat(
  chatlas.content_pdf_file("./presentation/images/data-projects-in-monterrey-mexico.pdf"),
